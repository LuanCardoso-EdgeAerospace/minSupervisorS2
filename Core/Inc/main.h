...
#define MCU_OSC_32k_IN_Pin GPIO_PIN_14
#define MCU_OSC_32k_IN_GPIO_Port GPIOC
#define MCU_OSC_32k_OUT_Pin GPIO_PIN_15
#define MCU_OSC_32k_OUT_GPIO_Port GPIOC
#define MCU_XTAL_IN_Pin GPIO_PIN_0
#define MCU_XTAL_IN_GPIO_Port GPIOF
#define MCU_XTAL_OUT_Pin GPIO_PIN_1
#define MCU_XTAL_OUT_GPIO_Port GPIOF
#define MCU_nRST_Pin GPIO_PIN_2
#define MCU_nRST_GPIO_Port GPIOF
#define IN_VOL_MEAS_Pin GPIO_PIN_0
#define IN_VOL_MEAS_GPIO_Port GPIOC
...
#define STATUS_LED1_GREEN_Pin GPIO_PIN_8
#define STATUS_LED1_GREEN_GPIO_Port GPIOE
#define STATUS_LED2_RED_Pin GPIO_PIN_9
...
#define SNS_I2C_ALERT_Pin GPIO_PIN_6
#define SNS_I2C_ALERT_GPIO_Port GPIOC
#define UEFI_SDA_Pin GPIO_PIN_8
#define UEFI_SDA_GPIO_Port GPIOC
#define UEFI_SCL_Pin GPIO_PIN_9
#define UEFI_SCL_GPIO_Port GPIOC
#define PMIC_INTB_Pin GPIO_PIN_8
#define PMIC_INTB_GPIO_Port GPIOA
#define UEFI_SCLA9_Pin GPIO_PIN_9
#define UEFI_SCLA9_GPIO_Port GPIOA
#define UEFI_SDAA10_Pin GPIO_PIN_10
#define UEFI_SDAA10_GPIO_Port GPIOA
#define PMIC_POR_B_Pin GPIO_PIN_11
#define PMIC_POR_B_GPIO_Port GPIOA
#define MCU_THERMAL_ERR_Pin GPIO_PIN_12
#define MCU_THERMAL_ERR_GPIO_Port GPIOA
#define CFG3_Pin GPIO_PIN_15
#define CFG3_GPIO_Port GPIOA
#define CFG_ENABLE_N_Pin GPIO_PIN_10
#define CFG_ENABLE_N_GPIO_Port GPIOC
...
#define MCU_CPU_GPIO0_Pin GPIO_PIN_0
#define MCU_CPU_GPIO0_GPIO_Port GPIOD
#define MCU_CPU_GPIO1_Pin GPIO_PIN_1
#define MCU_CPU_GPIO1_GPIO_Port GPIOD
...
#define UEFI_CPU_EN_Pin GPIO_PIN_5
#define UEFI_CPU_EN_GPIO_Port GPIOD
#define UEFI_CPU_WP_Pin GPIO_PIN_6
#define UEFI_CPU_WP_GPIO_Port GPIOD
